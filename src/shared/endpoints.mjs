...
export const getPopularArticles = (options = {}) => {
  ...
  return fetch(`${backend}/api/articles/popular?limit=${limit}&desc=${desc}`);
};

export const getPopularBoards = () => {
  return fetch(`${backend}/api/boards/popular`);
};
...
export const getArticle = (articleId, boardId) => {
  return fetch(`${backend}/api/board/${boardId}/article/${articleId}`);
};

export const getComments = (articleId, boardId) => {
  return fetch(`${backend}/api/board/${boardId}/article/${articleId}/comments`);
};
